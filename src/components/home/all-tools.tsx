...
export default function AllTools() {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6" id="all-tools">
      <div className="mb-10 text-center">
        <h2 className="text-2xl font-bold sm:text-3xl">All Developer Tools</h2>
        <p className="mt-2 text-[#94A3B8]">
          Browse our complete collection of free, instant tools
        </p>
