        ...
        <div className="mb-10">
          ...
          <div className="border border-[#334155] rounded-lg overflow-hidden">
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7">
              {/* Header */}
              <div className="px-3 py-2 bg-[#1A1F3A] text-xs font-semibold text-[#94A3B8] border-b border-r border-[#334155]">
                Character
              </div>
              <div className="px-3 py-2 bg-[#1A1F3A] text-xs font-semibold text-[#94A3B8] border-b border-r border-[#334155]">
                Encoded
              ...
              {encodingTable.map((entry, i) => (
                <React.Fragment key={i}>
                  <div className="px-3 py-2 text-xs font-mono text-[#F1F5F9] border-b border-r border-[#334155] hover:bg-[#1A1F3A] transition-colors">
                    {entry.char === 'Space' ? '␣' : entry.char}
                  </div>
                  <div className="px-3 py-2 text-xs font-mono text-[#00D9FF] border-b border-r border-[#334155] hover:bg-[#1A1F3A] transition-colors">
                    {entry.encoded}
                  </div>
                </React.Fragment>
              ))}
